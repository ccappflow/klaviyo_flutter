...
class MethodChannelKlaviyoFlutter extends KlaviyoFlutterPlatform {
  ...
  Stream<KlaviyoRemoteMessage> onMessageStream() => onMessage();

  Stream<KlaviyoRemoteMessage> onMessageOpenedAppStream() => onMessageOpenedApp();
  ...
  Future<String> logEvent(String name, [Map<String, dynamic>? metaData]) async {
    final resultMap = await _channel.invokeMethod('logEvent', {'name': name, 'metaData': metaData});
  ...
  Future<bool> handlePush(Map<String, dynamic> message) async {
    if (!message.values.every((item) => item is String)) {
      throw new ArgumentError('Klaviyo push messages can only have string values');
    }

    final result = await _channel.invokeMethod<bool>('handlePush', {'message': message});
    return result ?? false;
  }
  ...
  @override
  Future<void> setEmail(String email) => _channel.invokeMethod('setEmail', {'email': email});
  ...
  @override
  Future<void> setFirstName(String firstName) => _channel.invokeMethod('setFirstName', {'firstName': firstName});

  @override
  Future<void> setLastName(String lastName) => _channel.invokeMethod('setLastName', {'lastName': lastName});

  @override
  Future<void> setTitle(String title) => _channel.invokeMethod('setTitle', {'title': title});
  ...
  @override
  Future<void> setImage(String image) => _channel.invokeMethod('setImage', {'image': image});

  @override
  Future<void> setAddress1(String address1) => _channel.invokeMethod('setAddress1', {'address': address1});

  @override
  Future<void> setAddress2(String address2) => _channel.invokeMethod('setAddress2', {'address': address2});

  @override
  Future<void> setCity(String city) => _channel.invokeMethod('setCity', {'city': city});

  @override
  Future<void> setCountry(String country) => _channel.invokeMethod('setCountry', {'country': country});

  @override
  Future<void> setLatitude(double latitude) => _channel.invokeMethod('setLatitude', {'latitude': latitude});

  @override
  Future<void> setLongitude(double longitude) => _channel.invokeMethod('setLongitude', {'longitude': longitude});

  @override
  Future<void> setRegion(String region) => _channel.invokeMethod('setRegion', {'region': region});

  @override
  Future<void> setZip(String zip) => _channel.invokeMethod('setZip', {'zip': zip});

  @override
  Future<void> setTimezone(String timezone) => _channel.invokeMethod('setTimezone', {'timezone': timezone});
